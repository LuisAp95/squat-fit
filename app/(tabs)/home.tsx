...
const notificationIcon = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M12 22c1.1 0 2-.9 2-2h-4c0 1.1.9 2 2 2zm6-6v-5c0-3.07-1.63-5.64-4.5-6.32V4c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5v.68C7.63 5.36 6 7.92 6 11v5l-2 2v1h16v-1l-2-2z" fill="#fe5802"/></svg>`;

// Componente de Cabecera
const HomeHeader = ({ name }) => (
  <View className="flex-row justify-between items-center mb-6">
    <View>
      <Text className="text-2xl font-bold text-red-squat">Hola, {name}</Text>
      <Text className="text-base text-black">¡Bienvenido de vuelta!</Text>
    </View>
...
const ProfileCompletionCard = () => {
  ...
  return (
    <View className="bg-purple-squat-1 p-5 rounded-xl mb-6">
      ...
      <Pressable 
        className="bg-red-squat w-32 h-10 rounded-lg justify-center items-center"
...
export default function Home() {
  ...
  return (
    <ScrollView className="flex-1 bg-white  p-6 pt-16">
      ...
      <Text className="text-xl font-bold text-red-squat mb-4">Feed de Actividad</Text>
      
      {/* Placeholder para el feed */}
      <View className="bg-gray-100 p-4 rounded-lg items-center justify-center h-48">
        <Text className="text-dim-gray">El feed de publicaciones aparecerá aquí.</Text>
      </View>
